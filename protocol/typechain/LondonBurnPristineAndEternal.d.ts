...
interface LondonBurnPristineAndEternalInterface extends ethers.utils.Interface {
  functions: {
...
export class LondonBurnPristineAndEternal extends Contract {
  ...
  'interface': LondonBurnPristineAndEternalInterface;
