...
interface LondonBurnGiftInterface extends ethers.utils.Interface {
  functions: {
    ...
    'mintGiftType(uint256[],tuple[])': FunctionFragment;
...
export class LondonBurnGift extends Contract {
