...
import type {
  LondonBurnEternal,
  LondonBurnEternalInterface,
} from "../LondonBurnEternal";
...
export class LondonBurnEternal__factory {
  static readonly abi = _abi;
  static createInterface(): LondonBurnEternalInterface {
    return new utils.Interface(_abi) as LondonBurnEternalInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LondonBurnEternal {
    return new Contract(address, _abi, signerOrProvider) as LondonBurnEternal;
  }
}
