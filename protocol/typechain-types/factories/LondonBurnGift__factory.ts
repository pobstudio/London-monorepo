...
export class LondonBurnGift__factory {
  static readonly abi = _abi;
  static createInterface(): LondonBurnGiftInterface {
    return new utils.Interface(_abi) as LondonBurnGiftInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider,
  ): LondonBurnGift {
    return new Contract(address, _abi, signerOrProvider) as LondonBurnGift;
  }
}
