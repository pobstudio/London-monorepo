import { Bound, Cord, Rect, RectByCorner, RectByTriangle } from '../types';
...
// assumes no ordering of the rect pts
export const isCordInRectExhaustive = (or: Rect, cord: Cord): Boolean => {
  return (
    (or[0][0] <= cord[0] &&
      or[1][0] >= cord[0] &&
      or[0][1] <= cord[1] &&
