import { Bound, Cord, Rect, Vec2 } from '../../../utils/src';
import { TxData as BaseTxData } from '../utils';
import { DIMENSIONS as SEASON_DIMENSIONS } from '@pob/common';

export const PPI = 300;
export const DIMENSIONS: Bound = SEASON_DIMENSIONS['genesis'];
